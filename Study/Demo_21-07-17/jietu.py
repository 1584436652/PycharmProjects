...
funnel.add("商品交易行为记录数据",
           ['下单', '发货', '琪悦收货', '琪悦发货','上飞机', "运输中"],
           [5000, 4000, 1000, 2000, 1000, 500],
           is_label_show=True,label_formatter='{b} {c} {d}',label_pos="outside",legend_orient='vertical', legend_pos='left')
...
#            label_formatter='{a} {b} {c} {d}%', label_pos="outside",
#
