...
from my_seesion import Demo_session
    ...
    def pySimpleGpUI_show(self):
        ...
        while True:
            ...
            #     window['key_second'].update(self.stock_file_address)
                ...
                while True:
                    try:
                        # and self.stock_file_address != None
                        if  self.detail_file_address != None and self.save_file_address != None \
                                and is_number(values["money"]) and is_number(values["date_input_text"]):
