...
def get_login(driver, url):
    driver.get(url)
    elem=driver.find_element_by_xpath('//*[@id="app"]/div/div[2]/div[2]/dl/div[2]/input')
    elem.send_keys('11111')
    elem=driver.find_element_by_xpath('//*[@id="app"]/div/div[2]/div[2]/dl/div[3]/input')
    elem.send_keys('11111')
    elem=driver.find_element_by_xpath('//*[@id="app"]/div/div[2]/div[2]/dl/div[4]/div[1]/button')
    elem.click()
    sleep(2)
